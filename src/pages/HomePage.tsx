    ...
    <div className="space-y-12 animate-fade-in">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-300 text-lg max-w-3xl mx-auto">
          {i18n.language === "en"
            ? "Modern football club with tradition and innovation. Follow all games, results and get your tickets."
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {/* Matchday Highlight Video unter den Ergebnissen */}
          <HighlightVideo
            videoId="56or6llhGwY"
            title="FC React United – Matchday Highlights"
          />
        </div>
